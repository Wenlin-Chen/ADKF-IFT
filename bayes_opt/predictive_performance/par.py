...
from bayes_opt.bo_utils import load_antibiotics_dataset, load_covid_moonshot_dataset, load_dockstring_dataset, load_cep_dataset, run_gp_ei_bo, min_so_far, task_to_batches, PARModelFeatureExtractor, create_gp
import numpy as np
import torch
...
if task_name == "anti":
    task = load_antibiotics_dataset("bayes_opt/antibiotics/antibiotics-dataset.xlsx", "fs_mol/preprocessing/utils/helper_files/")
elif task_name == "covid":
    task = load_covid_moonshot_dataset("bayes_opt/covid_moonshot/covid-moonshot-dataset.csv", "fs_mol/preprocessing/utils/helper_files/")
elif task_name == "dock":
    task = load_dockstring_dataset("bayes_opt/dockstring/dockstring-dataset-subsampled.csv", "fs_mol/preprocessing/utils/helper_files/")
elif task_name == "opv":
    task = load_cep_dataset("bayes_opt/organic_photovoltaics/cep-dataset-subsampled.csv", "fs_mol/preprocessing/utils/helper_files/")
else:
    raise ValueError
