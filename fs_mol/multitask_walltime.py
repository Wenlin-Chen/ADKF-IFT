...
from fs_mol.utils.test_utils import add_walltime_cli_args, eval_model, set_up_test_run
...
def main():
    ...
    out_dir, dataset = set_up_test_run("walltime_Multitask", args, torch=True)
